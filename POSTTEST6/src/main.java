...
public class main implements desc{
...
//    overload
    ...
    public void deskripsi() {
        ...
        System.out.println("""
            Karpet adalah bahan penutup lantai yang terbuat dari berbagai jenis bahan seperti wol, nilon, poliester, atau bahan sintetis lainnya. Karpet biasanya dirancang dengan berbagai motif dan warna yang berbeda untuk memberikan kesan estetik yang menarik pada ruangan.

            Karpet dapat digunakan sebagai penambah kehangatan dan kenyamanan di dalam ruangan, serta dapat meredam suara dan getaran dari lantai. Selain itu, karpet juga dapat melindungi lantai dari goresan dan kotoran.

            Untuk merawat karpet, disarankan untuk membersihkannya secara rutin dengan vakum dan membersihkannya secara berkala dengan metode pembersihan yang sesuai, tergantung pada jenis karpet dan tingkat kekotorannya.""");
        System.out.println("===============================");
    }

    public void deskripsi(int jumlah) {
        System.out.println("=========== Jumlah ===========");
        System.out.println("Jumlah Karpet yang tersedia: "+ jumlah);
        System.out.println("==============================");
    }
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (x) {
            ...
            System.out.println("5. Jumlah Karpet");
            System.out.println("6. Deskripsi Karpet");
            ...
            switch (pilihan) {
                ...
                case 4:
                    ...
                    break;
                case 5:
                    mn.deskripsi(kptKulit.size()+kptVinyl.size());
                    break;
                case 6:
                    mn.deskripsi();
                    break;
